...
import torch
import numpy as np
from pocket_diffusion_policy_3d.model.common import utils as mutils
...
class ConsistencyFM():
    ...
    def ode(self, init_input, model, reverse=False):
      ...
      from fast_diffusion_policy_3d.model.common.utils import from_flattened_numpy, to_flattened_numpy, get_score_fn
