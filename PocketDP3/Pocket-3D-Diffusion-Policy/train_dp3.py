...
sys.path.append(os.path.join(DP3_ROOT, 'Pocket-3D-Diffusion-Policy'))
sys.path.append(os.path.join(DP3_ROOT, 'Pocket-3D-Diffusion-Policy', 'pocket_diffusion_policy_3d'))
...
from pocket_diffusion_policy_3d.dataset.base_dataset import BaseDataset
from pocket_diffusion_policy_3d.env_runner.base_runner import BaseRunner
from pocket_diffusion_policy_3d.env_runner.robot_runner import RobotRunner
from pocket_diffusion_policy_3d.common.checkpoint_util import TopKCheckpointManager
from pocket_diffusion_policy_3d.common.pytorch_util import dict_apply, optimizer_to
from pocket_diffusion_policy_3d.model.diffusion.ema_model import EMAModel
from pocket_diffusion_policy_3d.model.common.lr_scheduler import get_scheduler
...
@hydra.main(
    version_base=None,
    config_path=str(pathlib.Path(__file__).parent.joinpath("pocket_diffusion_policy_3d", "config")),
)
def main(cfg):
